...
//卡品牌展示
//卡板、选中展示、
function showCardBrand (cardId,cardBrand,List){
...
//卡类、卡别显示
function analysiscardVersionList(cardBandType,cardVersionInfoList){
...
//卡类选中
function changeCardLevel(cardId, cardBrand, cardClass, cardVersionInfoList){
...
//动态加载图片
function atterImg(cardId , cardVersionInfoList){
...
//清除和选中图片
function checkedImg(cardId, cardBrand, cardClass, cardStyle, cardVersionInfoList){
...
//one卡图片加载
function atterImgOne(cardId , cardVersionInfoList , cardVersionClassInfoList){
...
//one卡选中项
function selectOneCard(cardVersion , cardVersionClassInfoList){
...
//外币卡展示项
function showforeignCard(cardBrand,List){
...
//显示外币卡图片
function showforeignCardImg(rebateCard,foreignInternationalCard,List){
...
function showHopeCard(cardId){
    ...
    var huanqiuCard = document.getElementById('huanqiuCard');
    if(cardId == "1029"){
        huanqiuCard.style.display="";
    }
}

//宠物卡 展示项
function showpetName(cardId){
...
//粤通卡 展示项
function showYueTong(cardId){
    var texingCard = document.getElementById('texingCard');  //车身颜色
